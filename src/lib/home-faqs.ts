...
export const HOME_FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Readiness is about capital efficiency, financial and governance strength, and systems that withstand public scrutiny, not just revenue. Start with our \"Are You IPO Ready?\" check, then we give you an honest assessment and roadmap.",
  },
  {
  ...
  },
  {
    ...
    a: "No. We raise growth capital through equity or Equity Related Instruments from the right investors, and pursue a listing only when it's right for you.",
  },
  {
